...
$r1 = TestHost "Preview" "noc-monitor-hub.preview.emergentagent.com" "https://network-monitor-hub-2.preview.emergentagent.com"
...
if (-not $r1.HttpOk -and $r2.HttpOk) {
    ...
    Write-Host "      https://network-monitor-hub-2.preview.emergentagent.com/downloads/argus-backend-deploy.zip" -ForegroundColor White
    Write-Host ""
...
Section "1. Test Center PREVIEW (Kubernetes)"
$r1 = TestHost "Preview" "noc-monitor-hub.preview.emergentagent.com" "https://device-scanner-pro-3.preview.emergentagent.com"
...
if (-not $r1.HttpOk -and $r2.HttpOk) {
    ...
    Write-Host ""
    Write-Host "    Pacchetto deploy:" -ForegroundColor Cyan
    Write-Host "      https://device-scanner-pro-3.preview.emergentagent.com/downloads/argus-backend-deploy.zip" -ForegroundColor White
    Write-Host ""
    Write-Host "    Procedura assistita: dopo aver scaricato e estratto, lancia deploy.ps1 da admin" -ForegroundColor Cyan
} elseif ($r1.HttpOk -and $r2.HttpOk) {
    Write-Host "    -> ENTRAMBI raggiungibili. Il problema NON era firewall." -ForegroundColor Green
