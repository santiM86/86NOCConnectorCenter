...
$r1 = TestHost "Preview" "noc-monitor-hub.preview.emergentagent.com" "https://device-monitor-94.preview.emergentagent.com"
...
if (-not $r1.HttpOk -and $r2.HttpOk) {
    ...
    Write-Host "      https://device-monitor-94.preview.emergentagent.com/downloads/argus-backend-deploy.zip" -ForegroundColor White
    Write-Host ""
