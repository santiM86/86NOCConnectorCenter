...
$r1 = TestHost "Preview" "noc-monitor-hub.preview.emergentagent.com" "https://noc-monitor-4.preview.emergentagent.com"
...
if (-not $r1.HttpOk -and $r2.HttpOk) {
    ...
    Write-Host "      https://noc-monitor-4.preview.emergentagent.com/downloads/argus-backend-deploy.zip" -ForegroundColor White
    Write-Host ""
