...
#   curl -fsSL https://noc-alert-hub-1.preview.emergentagent.com/downloads/v4.2.0/deploy-v4.2.0.sh -o /tmp/deploy-v4.2.0.sh
#   chmod +x /tmp/deploy-v4.2.0.sh
#   sudo -u arslan bash /tmp/deploy-v4.2.0.sh
# ==============================================================================
set -euo pipefail

PATCH_BASE="${PATCH_BASE:-https://noc-alert-hub-1.preview.emergentagent.com/downloads/v4.2.0}"
