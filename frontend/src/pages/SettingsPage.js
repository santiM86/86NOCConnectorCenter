      ...
      <div className="space-y-4 max-w-lg">
        ...
        <div className="noc-panel p-5">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-[var(--bg-border)]">
              <div>
                <p className="text-[var(--text-primary)] text-xs font-medium">Datto RMM API</p>
                <p className="text-[var(--text-muted)] text-[10px] mt-0.5">
                  Sync dispositivi Datto RMM (nome, MAC, IP, OS) e match automatico con switch ports — zero "Dispositivo sconosciuto".
                </p>
              </div>
              <Button size="sm" variant="outline"
                onClick={() => navigate("/settings/datto")}
                className="rounded-md text-xs h-7 border-[var(--bg-border)] hover:bg-[var(--bg-hover)]"
                data-testid="manage-datto-btn">
                Gestisci
              </Button>
            </div>
            <div className="flex items-center justify-between pt-3 border-t border-[var(--bg-border)]">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-[var(--bg-border)]">
              ...
              <Button size="sm" variant="outline"
                onClick={() => navigate("/tools/path-trace")}
                className="rounded-md text-xs h-7 border-[var(--bg-border)] hover:bg-[var(--bg-hover)]"
                data-testid="manage-path-trace-btn">
                Apri
              </Button>
            </div>
            <div className="flex items-center justify-between pt-3 border-t border-[var(--bg-border)]">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-[var(--bg-border)]">
              <div>
                <p className="text-[var(--text-primary)] text-xs font-medium">Correlazione Outage ISP (IODA / RIPEstat / Cloudflare Radar)</p>
                <p className="text-[var(--text-muted)] text-[10px] mt-0.5">
                  Stabilisce se un disservizio è un guasto DIFFUSO dell'operatore o ISOLATO alla sede. Alimenta "⚖️ Diagnosi colpa" (WAN) e gli alert Telegram proattivi. Verifica stato fonti e token Cloudflare.
                </p>
              </div>
              <Button size="sm" variant="outline"
                onClick={() => navigate("/settings/outage-sources")}
                className="rounded-md text-xs h-7 border-[var(--bg-border)] hover:bg-[var(--bg-hover)]"
                data-testid="manage-outage-sources-btn">
                Gestisci
              </Button>
            </div>
            <div className="flex items-center justify-between pt-3 border-t border-[var(--bg-border)]">
