@echo off
REM ============================================================================
REM 86NocConnector - Force Update to v3.4.9 (ASR-safe bootstrap)
REM ============================================================================
REM QUANDO USARLO:
...
REM   saranno automatici grazie al nuovo updater.cmd ASR-safe di v3.4.9+.
REM
REM COME USARLO:
REM   1. Scarica 86NocConnector_v3.4.9.zip da:
REM      https://<your-argus-domain>/downloads/86NocConnector_v3.4.9.zip
...
echo.
echo ==========================================================================
echo   86NocConnector - Force Update Bootstrap to v3.4.9
echo ==========================================================================
echo.
...
if not exist "%INSTALL_DIR%" (
    ...
    echo Usa invece l'installer completo: 86NocConnector_v3.4.9_install.zip
    echo.
    pause
    exit /b 3
)
...
echo.
echo ==========================================================================
echo   AGGIORNAMENTO COMPLETATO - Connector ora e' a v3.4.9
