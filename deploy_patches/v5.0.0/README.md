...
> https://noc-alert-hub-2.preview.emergentagent.com/argus-desktop-preview/
...
Invoke-WebRequest "https://noc-alert-hub-2.preview.emergentagent.com/downloads/v4.2.0/ArgusDesktop.exe" -OutFile "C:\Program Files\86NocAgent\ArgusDesktop.exe" -UseBasicParsing
